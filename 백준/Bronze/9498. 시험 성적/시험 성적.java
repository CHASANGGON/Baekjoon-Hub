...
public class Main{
    public static void main(String[] args) throws IOException{ // 아직까지 왜 쓰는지 잘 모름
        ...
        Scanner sc = new Scanner(System.in); // 느리지만 입력을 받는 간단한 방법
        ...
        else if(score <= 79 && score >= 70) System.out.print("C"); // 실행문이 한 줄이면 줄바꿈을 안 해도 됨
        else if(score <= 69 && score >= 60) System.out.print("D"); // 실행문이 한 줄이면 줄바꿈을 안 해도 됨
